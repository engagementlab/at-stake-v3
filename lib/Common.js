...
class Common extends Core {
    ...
    */
    ...
    GetConnectedPlayers(notDecider) {

        let players = _.pick(this._current_players, 
                        function(val, key, obj) { 
                            var condition = val.connected === true;

                            // If checking for decider, also check player is not decider 
                            if(notDecider && condition)
                                condition = !val.decider;
    ...
    */
    PlayerReady(player, socket, assignDecider) {
        ...
        if(playerRejoining) {
            ...
            reconnectInfo.screen_index = this._current_screen_index;
            reconnectInfo.phase_index = this.currentPhaseIndex;
            ...
            this.LoadCurrentScreenForSocket(player.socket_id);
    ...
    */
    PlayerRemove(player) {
        ...
        super.PlayerRemove(player, true);
