...
class GameLogic extends Common {
    ...
    StartGame(socket, showTutorial) {
        ...
        // Load team info
        this.Templates.Load('partials/shared/teaminfo', this.GetActivePlayers(), (teamHtml) => {
    ...
    */
    ...
    PlayerCallVote(socket) {
        ...
        this.Templates.Load('partials/shared/vote', this.GetPlayerById(socket.id), (html) => {
    ...
    PlayerVote(socket, vote) {
        ...
        if(this.votesReceived === _.keys(this.GetActivePlayers()).length) {
            ...
            this.groupSocket.to(this.players_id).emit('players:voted', {yes: voteWon});
            this.votesYes = 0;
            this.votesReceived = 0;
        }
