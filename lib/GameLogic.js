...
class GameLogic extends Common {
        ...
        if(screenType === 'decider') {
            ...
            switch(screenName) {
                ...
                case 'scoreboard':
                    ...
                    console.log(this.GetActivePlayers(), " shared roles ");
    ...
    FindScreen(screenName, isPlayerOnly, refreshCurrent) {
        ...
        if(isShared) {
            ...
            this.ShowSharedScreen(screenName, sharedData, isUnique);
    ...
    ShowSharedScreen(screenName, data, isUnique) {

        this.ShowScreen(screenName, true, 'shared', data, isUnique);
    ...
    */
            ...
            if(partialsDir === 'decider') {
                ...
                if(uniqueData) {
                   ...
                   this.Templates.Load('partials/shared/' + screenName, data, (html) => {
                        ...
                        this.groupSocket.to(this._current_decider.socket_id).emit('game:next_phase', html);
                   ...
                   this.Templates.Load('partials/shared/' + screenName, data, (html) => {
                        ...
                        this.groupSocket.to(this._current_decider.socket_id).emit('game:next_phase', html);
                        this.groupSocket.to(this.players_id).emit('game:next_phase', html);
    ...
    AgendaItemAction(approve) {
        ...
        this.groupSocket.to(this._current_decider.socket_id).emit('game:next_phase_item');
