...
class GameLogic extends Common {
        ...
        switch(screenName) {
            ...
            case 'meet':
                ...
                screenData = { 
                                ...
                                players: _.map(this._current_players, 
                                            (player) => { 
                                                return { 
            ...
            case 'doubledown':
                ...
                screenData.players = this.Shuffler(_.mapObject(this.GetActivePlayers(), 
                                 (player) => { 
                                    return { 
                                        username: player.username,
                                        uid: player.uid, 
    ...
    */
    ...
    AgendaItemAction(approve) {
        ...
        console.log(this.GetConfig().rewardAmounts, " REWARD AMOUNT")
        ...
        if(approve) {
            ...
            console.log(reward, " this is the agenda reward")
