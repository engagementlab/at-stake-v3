...
class GameLogic extends Common {
    ...
    */
    ShowScreen(screenName, data, uniqueData, refreshCurrent, socket) {
        ...
        let seconds = (screenName === 'meet') ? this.GetConfig().thinkSeconds : this.GetConfig().pitchSeconds;
    ...
    */
    ...
    ShowEvent() {
        ...
        this.groupSocket.to(this.players_id).emit('player:show_event');        
    ...
    GameRating(ratingData) {
        ...
        // TODO: Decide win state

        this.Templates.Load('partials/shared/end', {won:true}, (html) => {
