            ...
            if(uniqueData) {
                ...
                if (screenName == 'meet') {
                    ...
                    this.Templates.Load('partials/shared/' + screenName, data, (html) => {
                        ...
                        this.groupSocket.to(this._current_decider.socket_id).emit(eventId, {html:html, data:round});
                        this.groupSocket.to(this.players_id).emit(eventId, {html:html, data:round});
